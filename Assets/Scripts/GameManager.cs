...
public class GameManager : MonoBehaviour
{
    ...
    {
        Int32 result =
            (player.entity.resistence * 10) + (player.entity.level * 4) + 10;
    ...
    {
        Int32 result =
            (player.entity.resistence + player.entity.willPower) +
            (player.entity.level * 4) +
            10;
    ...
    {
        Int32 result =
            (player.entity.resistence * 8) + (player.entity.level * 4) + 10;
    ...
    public Int32 CalculateDamage(Player player, int armorDamage)
    {
        ...
        Int32 result =
            (player.entity.damage * 3) + (armorDamage * 2) + rand.Next(1, 20);
